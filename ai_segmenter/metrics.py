...
class MetricsMixin:
    def show_metrics_info(self):
        ...
        text = (
            ...
            "Vergleichswert für Modell-Benchmarks.\n\n"
            ...
            "verfügbar ist. Diese Zeit wird getrennt von der Rechenzeit angezeigt.\n\n"
            "Main AI: Reine Modellzeit für die Haupt-Maskenberechnung, z.B. RVM, "
            ...
            "Frame-Latenz addiert, weil die Hauptpipeline mit der zuletzt verfügbaren "
            "Objektauswahl weiterläuft. Das Alter zeigt, wie alt die aktuelle YOLO-Erkennung ist.\n\n"
